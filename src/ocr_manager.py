        ...
        try:
            ...
            if OCR_ENGINE == "paddle":
                ...
                if results and results[0]:
                    texts = [item[1][0] for item in results[0] if item[1][1] > 0.5]                    
                    raw_text = ' '.join(texts)
                else:
                    raw_text = ""
            else:
